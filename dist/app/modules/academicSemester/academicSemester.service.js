...
const updateSemester = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const isExists = yield academicSemester_model_1.AcademicSemester.findOne({
        year: payload.year,
        title: payload.title,
    });
    if (isExists) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, 'Can not update as it is already in Database');
    }
    if (payload.title &&
        payload.code &&
