...
router.patch('/:id', (0, validateRequest_1.validateRequest)(student_validate_1.StudentValidate.updateStudentZodSchema), student_controller_1.StudentController.updateStudent);
