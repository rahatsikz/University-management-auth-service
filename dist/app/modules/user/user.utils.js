...
exports.generateFacultyID =
  ...
  exports.findLastStudnetID =
    void 0
const user_model_1 = require('./user.model')
const findLastStudnetID = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    return (
      (lastStudent === null || lastStudent === void 0
        ? void 0
        : lastStudent.id) && lastStudent.id.substring(4)
    )
  })
...
const generateStudentID = academicSemester =>
  __awaiter(void 0, void 0, void 0, function* () {
    const currentID =
      (yield (0, exports.findLastStudnetID)()) ||
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    return (
      (lastFaculty === null || lastFaculty === void 0
        ? void 0
        : lastFaculty.id) && lastFaculty.id.substring(2)
    )
  })
