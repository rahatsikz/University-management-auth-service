...
// create admin
router.post('/create-admin', (0, validateRequest_1.validateRequest)(user_validate_1.UserValidate.createAdminZodSchema), user_controller_1.UserController.createAdmin);
